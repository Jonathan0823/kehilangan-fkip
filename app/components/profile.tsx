...
const Profile: React.FC<ProfileProps> = ({ id, nama, prodi, image, angkatan, email, laporan }) => {
        ...
        <div className="flex justify-center items-center h-screen bg-gray-100">
            <div className="bg-white shadow-md rounded-lg p-6 w-full max-w-md">
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-sm text-gray-600">Nama</label>
                        <input
                            type="text"
                            id="name"
                            value={name}
                    ...
                    <div>
                        <label htmlFor="program" className="block text-sm text-gray-600">Program Studi</label>
                        <input
                            type="text"
                            id="program"
                            value={program}
                    ...
                    <div>
                        <label htmlFor="angkatan" className="block text-sm text-gray-600">Angkatan</label>
                        <input
                            type="number"
                            id="angkatan"
                            value={angk}
                ...
                <div className="mt-6 flex justify-between">
                    ...
                    <div className="w-28 h-12 ">
                        <button
                            ...
                            disabled={loading}
                            className={`flex justify-center items-center space-x-2 px-3 py-1.5 rounded-md shadow-lg transition duration-300 ${loading ? "bg-gray-400" : "bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 text-white"}`}
                        >
