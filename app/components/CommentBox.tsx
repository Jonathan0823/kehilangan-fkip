...
const CommentBox = ({ postId }: CommentBoxProps) => {
  ...
  return (
    <div className="w-full md:max-w-2xl">
      <div className="bg-white pb-28 p-4 mt-2 items-center text-center justify-center  rounded-3xl shadow md:max-w-2xl max-w-full mx-2 ">
                ...
                {user?.id === comment.userId && (
                  ...
                  >
                    {deletingId === comment.id ? (
                      <FaSpinner className="animate-spin text-red-600 w-5 h-5 mb-5" />
                    ) : (
